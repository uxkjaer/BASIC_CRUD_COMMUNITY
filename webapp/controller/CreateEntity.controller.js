sap.ui.define([
	...
	return BaseController.extend("Agilux.Community.controller.CreateEntity", {
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("AddressSet", {
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("AddressSet", oData);
