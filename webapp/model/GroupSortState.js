sap.ui.define([
	...
	return BaseObject.extend("Agilux.Community.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias Agilux.Community.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "Adrnr");
			}
